...
var _elm_lang$virtual_dom$VirtualDom_History$groupToggleButton = function (s) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$virtual_dom$VirtualDom_Helpers$class('messages-group-button'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$virtual_dom$VirtualDom_Helpers$class('messages-group-button-text'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$virtual_dom$VirtualDom_Helpers$text(s),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _elm_lang$virtual_dom$VirtualDom_History$groupFolderHelp = function (group) {
	if (_elm_lang$core$Native_Utils.cmp(group.numMessages, 1) < 1) {
		...
		if (group.closed) {
			return {
				ctor: '::',
				_0: _elm_lang$virtual_dom$VirtualDom_History$groupToggleButton('+'),
				_1: {ctor: '[]'}
			};
		} else {
			...
			var groupGuide = A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$virtual_dom$VirtualDom_Helpers$class('messages-group-guide'),
					_1: {
						ctor: '::',
						_0: _elm_lang$virtual_dom$VirtualDom_Helpers$style(
							{
...
var _elm_lang$virtual_dom$VirtualDom_History$nextAddress = F2(
	function (forward, groupClosed) {
		return groupClosed ? (forward ? _elm_lang$virtual_dom$VirtualDom_History$incrementGroup : _elm_lang$virtual_dom$VirtualDom_History$decrementGroup) : (forward ? _elm_lang$virtual_dom$VirtualDom_History$increment : _elm_lang$virtual_dom$VirtualDom_History$decrement);
	});
			...
			A2(
				...
				function (t1) {
					return A2(
						...
						function (t2) {
							return _elm_lang$core$Native_Utils.cmp(t2 - t1, 120) < 0;
						},
						timestamp2);
				},
				timestamp1));
	});
var _elm_lang$virtual_dom$VirtualDom_History$isSameGroup = F2(
	function (groupName1, groupName2) {
...
var _elm_lang$virtual_dom$VirtualDom_History$updateLatestGroup = F4(
	function (fast, imported, msg, group) {
		var closed = (_elm_lang$core$Native_Utils.eq(group.numMessages, 1) && fast) ? true : ((_elm_lang$core$Native_Utils.eq(group.numMessages, 5) && imported) ? true : group.closed);
		return _elm_lang$core$Native_Utils.update(
			group,
			{
				closed: closed,
				messages: {ctor: '::', _0: msg, _1: group.messages},
...
var _elm_lang$virtual_dom$VirtualDom_History$consEncodedGroup = F2(
	function (group, allMessages) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (elm, msgs) {
...
var _elm_lang$virtual_dom$VirtualDom_History$consEncodedGroups = F2(
	function (groups, allMessages) {
		return A3(_elm_lang$core$Array$foldl, _elm_lang$virtual_dom$VirtualDom_History$consEncodedGroup, allMessages, groups);
	});
var _elm_lang$virtual_dom$VirtualDom_History$consEncodedSnapshot = F2(
	function (snapshot, allMessages) {
		return A2(_elm_lang$virtual_dom$VirtualDom_History$consEncodedGroups, snapshot.groups, allMessages);
	});
var _elm_lang$virtual_dom$VirtualDom_History$encode = function (_p3) {
	var _p4 = _p3;
	var recentJson = A2(
		...
		{ctor: '[]'});
	return _elm_lang$core$Json_Encode$list(
		A3(_elm_lang$core$Array$foldr, _elm_lang$virtual_dom$VirtualDom_History$consEncodedSnapshot, recentJson, _p4.snapshots));
};
...
var _elm_lang$virtual_dom$VirtualDom_History$lastMessage = function (group) {
	...
	if (_p5.ctor === '[]') {
		return _elm_lang$core$Native_Utils.crashCase(
			...
			_p5)('Group must contain at least one message.');
	} else {
		return _p5._0;
	}
};
...
var _elm_lang$virtual_dom$VirtualDom_History$initialModel = function (_p7) {
	var _p8 = _p7;
	var _p9 = A2(_elm_lang$core$Array$get, 0, _p8.snapshots);
	if (_p9.ctor === 'Just') {
		return _p9._0.model;
	} else {
		return _p8.recent.model;
	}
};
...
var _elm_lang$virtual_dom$VirtualDom_History$add = F4(
	function (timestamp, msg, model, _p12) {
		var _p13 = _p12;
		var _p16 = _p13.snapshots;
		var _p15 = _p13.numMessages;
		var imported = _elm_lang$core$Native_Utils.eq(timestamp, _elm_lang$core$Maybe$Nothing);
		var fast = A2(_elm_lang$virtual_dom$VirtualDom_History$isImmediateAfter, _p13.lastTimestamp, timestamp);
		var groupName = _elm_lang$virtual_dom$Native_Debug.messageToGroupName(msg);
		var sameGroup = A2(_elm_lang$virtual_dom$VirtualDom_History$isSameGroup, groupName, _p13.lastGroupName);
		var _p14 = A6(_elm_lang$virtual_dom$VirtualDom_History$addRecent, sameGroup, fast, imported, msg, model, _p13.recent);
		if (_p14._0.ctor === 'Just') {
			return A5(
				_elm_lang$virtual_dom$VirtualDom_History$History,
				A2(_elm_lang$core$Array$push, _p14._0._0, _p16),
				_p14._1,
				_p15 + 1,
				timestamp,
				groupName);
		} else {
			return A5(_elm_lang$virtual_dom$VirtualDom_History$History, _p16, _p14._1, _p15 + 1, timestamp, groupName);
		}
	});
var _elm_lang$virtual_dom$VirtualDom_History$decoder = F2(
	function (initialModel, update) {
		var addMessage = F2(
			function (rawMsg, _p17) {
				var _p18 = _p17;
				var _p19 = _p18._0;
				var msg = _elm_lang$virtual_dom$VirtualDom_History$jsToElm(rawMsg);
				return {
					ctor: '_Tuple2',
					_0: A2(update, msg, _p19),
					_1: A4(_elm_lang$virtual_dom$VirtualDom_History$add, _elm_lang$core$Maybe$Nothing, msg, _p19, _p18._1)
				};
			});
...
var _elm_lang$virtual_dom$VirtualDom_History$toggleGroup = F3(
	function (closed, address, history) {
		var _p20 = A3(_elm_lang$virtual_dom$VirtualDom_History$getGroup, address.snapshot, address.group, history);
		if (_p20.ctor === 'Just') {
			var _p22 = _p20._0;
			return ((_elm_lang$core$Native_Utils.cmp(_p22.numMessages, 2) > -1) && (!_elm_lang$core$Native_Utils.eq(_p22.closed, closed))) ? {
				ctor: '_Tuple2',
				_0: A4(
...
var _elm_lang$virtual_dom$VirtualDom_History$Group = F3(
	function (a, b, c) {
		return {closed: a, messages: b, numMessages: c};
	});
var _elm_lang$virtual_dom$VirtualDom_History$Address = F3(
	function (a, b, c) {
		return {snapshot: a, group: b, message: c};
	});
var _elm_lang$virtual_dom$VirtualDom_History$latestAddress = function (history) {
	return A2(
		_elm_lang$virtual_dom$VirtualDom_History$validateAddress,
		history,
		A3(
			_elm_lang$virtual_dom$VirtualDom_History$Address,
			_elm_lang$core$Array$length(history.snapshots),
			_elm_lang$virtual_dom$VirtualDom_History$lastIndex,
			_elm_lang$virtual_dom$VirtualDom_History$lastIndex));
};
var _elm_lang$virtual_dom$VirtualDom_History$firstAddress = A3(_elm_lang$virtual_dom$VirtualDom_History$Address, 0, 0, 0);
var _elm_lang$virtual_dom$VirtualDom_History$nextVisibleAddress = F3(
	function (forward, from, history) {
		var _p24 = A3(_elm_lang$virtual_dom$VirtualDom_History$getGroup, from.snapshot, from.group, history);
		if (_p24.ctor === 'Just') {
			var _p25 = A2(
				_elm_lang$virtual_dom$VirtualDom_History$validateAddress,
				history,
				A3(_elm_lang$virtual_dom$VirtualDom_History$nextAddress, forward, _p24._0.closed, from));
			if (_p25.ctor === 'Nothing') {
				return forward ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_elm_lang$virtual_dom$VirtualDom_History$firstAddress);
			} else {
				return _p25;
			}
		} else {
...
var _elm_lang$virtual_dom$VirtualDom_History$getHelpHelp = F3(
	function (update, msg, getResult) {
		...
		if (_p27.ctor === 'Done') {
			...
			var _p29 = _p27._0;
			var _p28 = _p27._1;
			return _elm_lang$core$Native_Utils.eq(_p29, 0) ? A2(
				_elm_lang$virtual_dom$VirtualDom_History$Done,
				msg,
				A2(update, msg, _p28)) : A2(
...
var _elm_lang$virtual_dom$VirtualDom_History$getHelp = F4(
	function (update, messageIndex, group, getResult) {
		...
		if (_p30.ctor === 'Done') {
			...
			var _p32 = _p30._0;
			var _p31 = _p30._1;
			return _elm_lang$core$Native_Utils.eq(_p32, 0) ? A3(
				_elm_lang$core$List$foldr,
				_elm_lang$virtual_dom$VirtualDom_History$getHelpHelp(update),
				A2(_elm_lang$virtual_dom$VirtualDom_History$Stepping, messageIndex, _p31),
				group.messages) : A2(
				_elm_lang$virtual_dom$VirtualDom_History$Stepping,
				_p32 - 1,
				A3(_elm_lang$core$List$foldr, update, _p31, group.messages));
		}
	});
var _elm_lang$virtual_dom$VirtualDom_History$get = F3(
	function (update, address, history) {
		var _p33 = A2(_elm_lang$virtual_dom$VirtualDom_History$getSnapshot, address.snapshot, history);
		if (_p33.ctor === 'Just') {
			var _p34 = _p33._0;
			var updateHelp = F2(
				function (msg, model) {
			...
			return _elm_lang$virtual_dom$VirtualDom_History$undone(
				A3(
					...
					A2(_elm_lang$virtual_dom$VirtualDom_History$Stepping, address.group, _p34.model),
					_p34.groups));
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'VirtualDom.History',
...
var _elm_lang$virtual_dom$VirtualDom_History$Select = function (a) {
	return {ctor: 'Select', _0: a};
};
var _elm_lang$virtual_dom$VirtualDom_History$viewRow = F3(
	function (selected, index, content) {
		var msg = F3(
			function (msgIndex, groupIndex, snapshotIndex) {
				return _elm_lang$virtual_dom$VirtualDom_History$Select(
					A3(_elm_lang$virtual_dom$VirtualDom_History$Address, snapshotIndex, groupIndex, msgIndex));
			});
		var className = selected ? 'messages-entry messages-entry-selected' : 'messages-entry';
		return A2(
			_elm_lang$virtual_dom$VirtualDom_Helpers$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$virtual_dom$VirtualDom_Helpers$text(content),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$virtual_dom$VirtualDom_Helpers$text(index),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _elm_lang$virtual_dom$VirtualDom_History$viewClosedGroup = F5(
	function (currentAddress, groupIndex, firstIndex, lastIndex, msg) {
		...
		var selected = function () {
			...
			if (_p36.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p36._0.group, groupIndex);
			} else {
				return false;
			}
		}();
		return A2(
			...
			A4(
				_elm_lang$virtual_dom$VirtualDom_Helpers$lazy3,
				_elm_lang$virtual_dom$VirtualDom_History$viewRow,
				selected,
				indexStr,
...
var _elm_lang$virtual_dom$VirtualDom_History$viewMessage = F4(
	function (currentAddress, index, msgIndex, msg) {
		var selected = function () {
			var _p37 = currentAddress;
			if (_p37.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p37._0.message, msgIndex);
			} else {
				return false;
			}
		}();
...
var _elm_lang$virtual_dom$VirtualDom_History$consMsg = F3(
	function (currentAddress, msg, _p38) {
		var _p39 = _p38;
		var _p41 = _p39._1;
		var _p40 = _p39._0;
		return {
			...
			_2: {
				ctor: '::',
				_0: A4(_elm_lang$virtual_dom$VirtualDom_History$viewMessage, currentAddress, _p40, _p41, msg),
				_1: _p39._2
			}
		};
	});
var _elm_lang$virtual_dom$VirtualDom_History$CloseGroup = function (a) {
	return {ctor: 'CloseGroup', _0: a};
};
var _elm_lang$virtual_dom$VirtualDom_History$OpenGroup = function (a) {
	return {ctor: 'OpenGroup', _0: a};
};
var _elm_lang$virtual_dom$VirtualDom_History$groupFolder = function (group) {
	var msg = F2(
		function (groupIndex, snapshotIndex) {
			return (group.closed ? _elm_lang$virtual_dom$VirtualDom_History$OpenGroup : _elm_lang$virtual_dom$VirtualDom_History$CloseGroup)(
				A3(_elm_lang$virtual_dom$VirtualDom_History$Address, snapshotIndex, groupIndex, 0));
		});
	return A2(
		_elm_lang$virtual_dom$VirtualDom_Helpers$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$virtual_dom$VirtualDom_Helpers$class('message-group-folder'),
				_1: {ctor: '[]'}
			}
		},
		_elm_lang$virtual_dom$VirtualDom_History$groupFolderHelp(group));
};
var _elm_lang$virtual_dom$VirtualDom_History$viewGroup = F4(
	function (currentAddress, index, groupIndex, group) {
		var folder = A2(_elm_lang$virtual_dom$VirtualDom_Helpers$lazy, _elm_lang$virtual_dom$VirtualDom_History$groupFolder, group);
		var children = group.closed ? {
			...
			A3(
				_elm_lang$core$List$foldl,
				_elm_lang$virtual_dom$VirtualDom_History$consMsg(currentAddress),
				{
					ctor: '_Tuple3',
					_0: index,
					_1: group.numMessages - 1,
					_2: {ctor: '[]'}
				},
				group.messages));
		return A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$virtual_dom$VirtualDom_Helpers$class('messages-group'),
					_1: {ctor: '[]'}
				},
				{ctor: '::', _0: folder, _1: children}));
	});
var _elm_lang$virtual_dom$VirtualDom_History$consGroup = F3(
	function (currentAddress, group, _p44) {
		var _p45 = _p44;
		var _p47 = _p45._0;
		var _p46 = _p45._1;
		var currentAddressHelp = A2(
			_elm_lang$core$Maybe$andThen,
			_elm_lang$virtual_dom$VirtualDom_History$filterAddressByGroup(_p46),
			currentAddress);
		return {
			ctor: '_Tuple3',
			_0: _p47 - group.numMessages,
			_1: _p46 - 1,
			_2: {
				ctor: '::',
				_0: A4(_elm_lang$virtual_dom$VirtualDom_History$viewGroup, currentAddressHelp, _p47, _p46, group),
				_1: _p45._2
			}
		};
	});
var _elm_lang$virtual_dom$VirtualDom_History$viewSnapshot = F3(
	function (currentAddress, index, _p48) {
		var _p49 = _p48;
		var _p52 = _p49.groups;
		return A2(
			_elm_lang$virtual_dom$VirtualDom_Helpers$div,
			{ctor: '[]'},
			function (_p50) {
...
var _elm_lang$virtual_dom$VirtualDom_History$consSnapshot = F3(
	function (currentAddress, snapshot, _p53) {
		var _p54 = _p53;
		var _p56 = _p54._1;
		var _p55 = _p54._0;
		var currentAddressHelp = A2(
			_elm_lang$core$Maybe$andThen,
			_elm_lang$virtual_dom$VirtualDom_History$filterAddressBySnapshot(_p56),
			currentAddress);
		return {
			ctor: '_Tuple3',
			_0: _p55 - snapshot.numMessages,
			_1: _p56 - 1,
			_2: {
				ctor: '::',
				_0: A2(
					...
					A4(_elm_lang$virtual_dom$VirtualDom_Helpers$lazy3, _elm_lang$virtual_dom$VirtualDom_History$viewSnapshot, currentAddressHelp, _p55, snapshot)),
				_1: _p54._2
			}
		};
	});
...
var _elm_lang$virtual_dom$VirtualDom_Debug$ToggleGroup = F2(
	function (a, b) {
		return {ctor: 'ToggleGroup', _0: a, _1: b};
	});
var _elm_lang$virtual_dom$VirtualDom_Debug$Right = {ctor: 'Right'};
var _elm_lang$virtual_dom$VirtualDom_Debug$Left = {ctor: 'Left'};
...
var _elm_lang$virtual_dom$VirtualDom_Debug$viewResumeButton = function (maybeAddress) {
	var _p7 = maybeAddress;
	if (_p7.ctor === 'Nothing') {
		return _elm_lang$virtual_dom$VirtualDom_Helpers$text('');
	} else {
...
var _elm_lang$virtual_dom$VirtualDom_Debug$playButton = function (maybeAddress) {
	return A2(
		_elm_lang$virtual_dom$VirtualDom_Helpers$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _elm_lang$virtual_dom$VirtualDom_Debug$viewResumeButton(maybeAddress),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$virtual_dom$VirtualDom_Helpers$div,
...
var _elm_lang$virtual_dom$VirtualDom_Debug$viewSidebar = F2(
	function (state, history) {
		var transform = function (historyMsg) {
			var _p8 = historyMsg;
			switch (_p8.ctor) {
				case 'Select':
					return _elm_lang$virtual_dom$VirtualDom_Debug$Jump(_p8._0);
				case 'OpenGroup':
					return A2(_elm_lang$virtual_dom$VirtualDom_Debug$ToggleGroup, true, _p8._0);
				default:
					return A2(_elm_lang$virtual_dom$VirtualDom_Debug$ToggleGroup, false, _p8._0);
			}
		};
		var maybeAddress = function () {
			var _p9 = state;
			if (_p9.ctor === 'Running') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					_elm_lang$virtual_dom$VirtualDom_Helpers$map,
					transform,
					A2(_elm_lang$virtual_dom$VirtualDom_History$view, maybeAddress, history)),
				_1: {
					ctor: '::',
					_0: _elm_lang$virtual_dom$VirtualDom_Debug$playButton(maybeAddress),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _elm_lang$virtual_dom$VirtualDom_Debug$viewOut = function (_p10) {
	var _p11 = _p10;
	return A2(
		_elm_lang$virtual_dom$VirtualDom_Helpers$div,
		{
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$virtual_dom$VirtualDom_Debug$viewSidebar, _p11.state, _p11.history),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$virtual_dom$VirtualDom_Helpers$map,
						...
						A2(
							...
							{
								ctor: '::',
								_0: A2(_elm_lang$virtual_dom$VirtualDom_Expando$view, _elm_lang$core$Maybe$Nothing, _p11.expando),
								_1: {ctor: '[]'}
							})),
					_1: {ctor: '[]'}
				}
...
var _elm_lang$virtual_dom$VirtualDom_Debug$UserMsgWithTimestamp = F2(
	function (a, b) {
		return {ctor: 'UserMsgWithTimestamp', _0: a, _1: b};
	});
var _elm_lang$virtual_dom$VirtualDom_Debug$UserMsg = function (a) {
	return {ctor: 'UserMsg', _0: a};
};
var _elm_lang$virtual_dom$VirtualDom_Debug$wrapInit = F2(
	function (metadata, _p12) {
		var _p13 = _p12;
		var _p14 = _p13._0;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{
				history: _elm_lang$virtual_dom$VirtualDom_History$empty(_p14),
				state: _elm_lang$virtual_dom$VirtualDom_Debug$Running(_p14),
				expando: _elm_lang$virtual_dom$VirtualDom_Expando$init(_p14),
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _elm_lang$virtual_dom$VirtualDom_Debug$UserMsg, _p13._1),
				_1: {ctor: '[]'}
			});
	});
var _elm_lang$virtual_dom$VirtualDom_Debug$wrapSubs = F2(
	function (userSubscriptions, _p15) {
		var _p16 = _p15;
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_elm_lang$virtual_dom$VirtualDom_Debug$UserMsg,
			userSubscriptions(
				_elm_lang$virtual_dom$VirtualDom_Debug$getLatestModel(_p16.state)));
	});
var _elm_lang$virtual_dom$VirtualDom_Debug$wrapView = F2(
	function (userView, _p17) {
		var _p18 = _p17;
		var currentModel = function () {
			var _p19 = _p18.state;
			if (_p19.ctor === 'Running') {
				return _p19._0;
			} else {
				return _p19._1;
			}
...
var _elm_lang$virtual_dom$VirtualDom_Debug$updateUserMsg = F5(
	function (userUpdate, scrollTask, timestamp, userMsg, _p21) {
		var _p22 = _p21;
		var _p26 = _p22.state;
		var _p25 = _p22;
		var userModel = _elm_lang$virtual_dom$VirtualDom_Debug$getLatestModel(_p26);
		var newHistory = A4(
			_elm_lang$virtual_dom$VirtualDom_History$add,
			_elm_lang$core$Maybe$Just(timestamp),
			userMsg,
			userModel,
			_p22.history);
		var _p23 = A2(userUpdate, userMsg, userModel);
		var newUserModel = _p23._0;
		var userCmds = _p23._1;
		var commands = A2(_elm_lang$core$Platform_Cmd$map, _elm_lang$virtual_dom$VirtualDom_Debug$UserMsg, userCmds);
		var _p24 = _p26;
		if (_p24.ctor === 'Running') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					_p25,
					{
						...
						expando: A2(_elm_lang$virtual_dom$VirtualDom_Expando$merge, newUserModel, _p22.expando)
					}),
				{
					ctor: '::',
					_0: commands,
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$virtual_dom$VirtualDom_Debug$runIf, _p25.isDebuggerOpen, scrollTask),
						_1: {ctor: '[]'}
					}
				});
		} else {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					...
					{
						history: newHistory,
						state: A3(_elm_lang$virtual_dom$VirtualDom_Debug$Paused, _p24._0, _p24._1, newUserModel)
					}),
				{
					ctor: '::',
					_0: commands,
	...
	function (userUpdate, scrollTask, msg, model) {
		...
		while (true) {
			...
			switch (_p27.ctor) {
				...
				case 'UserMsg':
					return A2(
						...
						model,
						{
							...
							_0: A2(
								_elm_lang$core$Task$perform,
								_elm_lang$virtual_dom$VirtualDom_Debug$UserMsgWithTimestamp(_p27._0),
								_elm_lang$core$Time$now),
							_1: {ctor: '[]'}
						});
				case 'UserMsgWithTimestamp':
					return A5(_elm_lang$virtual_dom$VirtualDom_Debug$updateUserMsg, userUpdate, scrollTask, _p27._1, _p27._0, model);
				case 'ExpandoMsg':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								expando: A2(_elm_lang$virtual_dom$VirtualDom_Expando$update, _p27._0, model.expando)
							}),
						{ctor: '[]'});
				case 'Resume':
					var _p28 = model.state;
					if (_p28.ctor === 'Running') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							{ctor: '[]'});
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									state: _elm_lang$virtual_dom$VirtualDom_Debug$Running(_p29),
									expando: A2(_elm_lang$virtual_dom$VirtualDom_Expando$merge, _p29, model.expando)
								}),
							{
								ctor: '::',
				...
				case 'Jump':
					var _p31 = _p27._0;
					var _p30 = A3(_elm_lang$virtual_dom$VirtualDom_History$get, userUpdate, _p31, model.history);
					var indexModel = _p30._0;
					var indexMsg = _p30._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				case 'Up':
					...
					if (_p32.ctor === 'Paused') {
						var _p33 = A2(_elm_lang$virtual_dom$VirtualDom_History$visibleAddressBefore, _p32._0, model.history);
						if (_p33.ctor === 'Just') {
							var _v19 = userUpdate,
								_v20 = scrollTask,
								_v21 = _elm_lang$virtual_dom$VirtualDom_Debug$Jump(_p33._0),
								_v22 = model;
							userUpdate = _v19;
							scrollTask = _v20;
							msg = _v21;
						...
						var _p34 = _elm_lang$virtual_dom$VirtualDom_History$latestAddress(model.history);
						if (_p34.ctor === 'Just') {
							var _v24 = userUpdate,
								_v25 = scrollTask,
								_v26 = _elm_lang$virtual_dom$VirtualDom_Debug$Jump(_p34._0),
								_v27 = model;
							userUpdate = _v24;
							scrollTask = _v25;
							msg = _v26;
				...
				case 'Down':
					...
					if (_p35.ctor === 'Running') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							{ctor: '[]'});
					} else {
						var _p36 = A2(_elm_lang$virtual_dom$VirtualDom_History$visibleAddressAfter, _p35._0, model.history);
						if (_p36.ctor === 'Nothing') {
							var _v30 = userUpdate,
								_v31 = scrollTask,
								_v32 = _elm_lang$virtual_dom$VirtualDom_Debug$Resume,
								_v33 = model;
							userUpdate = _v30;
							scrollTask = _v31;
							msg = _v32;
							...
							var _v34 = userUpdate,
								_v35 = scrollTask,
								_v36 = _elm_lang$virtual_dom$VirtualDom_Debug$Jump(_p36._0),
								_v37 = model;
							userUpdate = _v34;
							scrollTask = _v35;
							msg = _v36;
				...
				case 'Left':
					...
					if (_p37.ctor === 'Paused') {
						var _v39 = userUpdate,
							_v40 = scrollTask,
							_v41 = A2(_elm_lang$virtual_dom$VirtualDom_Debug$ToggleGroup, false, _p37._0),
							_v42 = model;
						userUpdate = _v39;
						scrollTask = _v40;
						msg = _v41;
				...
				case 'Right':
					...
					if (_p38.ctor === 'Paused') {
						var _v44 = userUpdate,
							_v45 = scrollTask,
							_v46 = A2(_elm_lang$virtual_dom$VirtualDom_Debug$ToggleGroup, true, _p38._0),
							_v47 = model;
						userUpdate = _v44;
						scrollTask = _v45;
						msg = _v46;
				...
				case 'ToggleGroup':
					var _p39 = A2(
						_p27._0 ? _elm_lang$virtual_dom$VirtualDom_History$openGroup : _elm_lang$virtual_dom$VirtualDom_History$closeGroup,
						_p27._1,
						model.history);
					var history = _p39._0;
					var nextAddress = _p39._1;
					var _v48 = userUpdate,
						_v49 = scrollTask,
						_v50 = _elm_lang$virtual_dom$VirtualDom_Debug$Jump(nextAddress),
				...
				case 'Upload':
					return A2(
						...
						model,
						function (metadata) {
							var _p41 = A2(_elm_lang$virtual_dom$VirtualDom_Overlay$assessImport, metadata, _p27._0);
							if (_p41.ctor === 'Err') {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
								...
								return A3(_elm_lang$virtual_dom$VirtualDom_Debug$loadNewHistory, _p41._0, userUpdate, model);
							}
						});
				default:
					var _p42 = A2(_elm_lang$virtual_dom$VirtualDom_Overlay$close, _p27._0, model.overlay);
					if (_p42.ctor === 'Nothing') {
						...
						return A3(_elm_lang$virtual_dom$VirtualDom_Debug$loadNewHistory, _p42._0, userUpdate, model);
					}
			}
		}
	});
var _elm_lang$virtual_dom$VirtualDom_Debug$wrap = F2(
	function (metadata, _p43) {
		var _p44 = _p43;
		return {
			init: A2(_elm_lang$virtual_dom$VirtualDom_Debug$wrapInit, metadata, _p44.init),
			view: _elm_lang$virtual_dom$VirtualDom_Debug$wrapView(_p44.view),
			update: _elm_lang$virtual_dom$VirtualDom_Debug$wrapUpdate(_p44.update),
			viewIn: _elm_lang$virtual_dom$VirtualDom_Debug$viewIn,
			viewOut: _elm_lang$virtual_dom$VirtualDom_Debug$viewOut,
			subscriptions: _elm_lang$virtual_dom$VirtualDom_Debug$wrapSubs(_p44.subscriptions)
		};
	});
var _elm_lang$virtual_dom$VirtualDom_Debug$wrapWithFlags = F2(
	function (metadata, _p45) {
		var _p46 = _p45;
		return {
			init: function (flags) {
				return A2(
			...
			view: _elm_lang$virtual_dom$VirtualDom_Debug$wrapView(_p46.view),
			update: _elm_lang$virtual_dom$VirtualDom_Debug$wrapUpdate(_p46.update),
			viewIn: _elm_lang$virtual_dom$VirtualDom_Debug$viewIn,
			viewOut: _elm_lang$virtual_dom$VirtualDom_Debug$viewOut,
			subscriptions: _elm_lang$virtual_dom$VirtualDom_Debug$wrapSubs(_p46.subscriptions)
		};
	});
...
var _elm_lang$virtual_dom$AltHtml$on = _elm_lang$virtual_dom$VirtualDom$on;
var _elm_lang$virtual_dom$AltHtml$onClick = function (msg) {
	return A2(
		_elm_lang$virtual_dom$AltHtml$on,
		'click',
		_elm_lang$core$Json_Decode$succeed(msg));
};
var _elm_lang$virtual_dom$AltHtml$style = _elm_lang$virtual_dom$VirtualDom$style;
var _elm_lang$virtual_dom$AltHtml$hr = _elm_lang$virtual_dom$VirtualDom$node('hr');
var _elm_lang$virtual_dom$AltHtml$button = _elm_lang$virtual_dom$VirtualDom$node('button');
var _elm_lang$virtual_dom$AltHtml$div = _elm_lang$virtual_dom$VirtualDom$node('div');
var _elm_lang$virtual_dom$AltHtml$text = _elm_lang$virtual_dom$VirtualDom$text;
var _elm_lang$virtual_dom$AltHtml$map = _elm_lang$virtual_dom$VirtualDom$map;
var _elm_lang$virtual_dom$AltHtml$program = _elm_lang$virtual_dom$VirtualDom$program;
var _elm_lang$virtual_dom$AltHtml$beginnerProgram = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$virtual_dom$AltHtml$program(
		{
			init: A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_p1.model,
...
var _elm_lang$virtual_dom$Main$getPosition = function (_p0) {
	var _p1 = _p0;
...
var _elm_lang$virtual_dom$Main$px = function (number) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(number),
		'px');
};
var _elm_lang$virtual_dom$Main_ops = _elm_lang$virtual_dom$Main_ops || {};
_elm_lang$virtual_dom$Main_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _elm_lang$virtual_dom$Main$Model = F2(
	function (a, b) {
		return {position: a, drag: b};
	});
var _elm_lang$virtual_dom$Main$init = {
	ctor: '_Tuple2',
	_0: A2(
		_elm_lang$virtual_dom$Main$Model,
		A2(_elm_lang$mouse$Mouse$Position, 200, 200),
		_elm_lang$core$Maybe$Nothing),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _elm_lang$virtual_dom$Main$Drag = F2(
	function (a, b) {
		return {start: a, current: b};
	});
var _elm_lang$virtual_dom$Main$updateHelp = F2(
	function (msg, _p6) {
		var _p7 = _p6;
		...
		switch (_p8.ctor) {
			case 'DragStart':
				...
				return A2(
					...
					_p12,
					_elm_lang$core$Maybe$Just(
						A2(_elm_lang$virtual_dom$Main$Drag, _p9, _p9)));
			case 'DragAt':
				return A2(
					_elm_lang$virtual_dom$Main$Model,
					_p12,
					A2(
						...
						function (_p10) {
							var _p11 = _p10;
							return A2(_elm_lang$virtual_dom$Main$Drag, _p11.start, _p8._0);
						},
						_p7.drag));
			default:
				return A2(
					_elm_lang$virtual_dom$Main$Model,
					_elm_lang$virtual_dom$Main$getPosition(_p7),
					_elm_lang$core$Maybe$Nothing);
		}
	});
var _elm_lang$virtual_dom$Main$update = F2(
	function (msg, model) {
		return {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$virtual_dom$Main$updateHelp, msg, model),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _elm_lang$virtual_dom$Main$DragEnd = function (a) {
	return {ctor: 'DragEnd', _0: a};
};
var _elm_lang$virtual_dom$Main$DragAt = function (a) {
	return {ctor: 'DragAt', _0: a};
};
var _elm_lang$virtual_dom$Main$subscriptions = function (model) {
	var _p13 = model.drag;
	if (_p13.ctor === 'Nothing') {
		...
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$moves(_elm_lang$virtual_dom$Main$DragAt),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$ups(_elm_lang$virtual_dom$Main$DragEnd),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _elm_lang$virtual_dom$Main$DragStart = function (a) {
	return {ctor: 'DragStart', _0: a};
};
var _elm_lang$virtual_dom$Main$onMouseDown = A2(
	_elm_lang$virtual_dom$AltHtml$on,
	'mousedown',
	A2(_elm_lang$core$Json_Decode$map, _elm_lang$virtual_dom$Main$DragStart, _elm_lang$mouse$Mouse$position));
var _elm_lang$virtual_dom$Main$view = function (model) {
	var realPosition = _elm_lang$virtual_dom$Main$getPosition(model);
	return A2(
		_elm_lang$virtual_dom$AltHtml$div,
		{
			ctor: '::',
			_0: _elm_lang$virtual_dom$Main$onMouseDown,
			_1: {
				ctor: '::',
				_0: _elm_lang$virtual_dom$AltHtml$style(
					{
						ctor: '::',
						_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'background-color', '#3C8D2F'),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'cursor', 'move'),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'width', '100px'),
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'height', '100px'),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'border-radius', '4px'),
										_1: {
											ctor: '::',
											_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'position', 'absolute'),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$virtual_dom$Main_ops['=>'],
													'left',
													_elm_lang$virtual_dom$Main$px(realPosition.x)),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$virtual_dom$Main_ops['=>'],
														'top',
														_elm_lang$virtual_dom$Main$px(realPosition.y)),
													_1: {
														ctor: '::',
														_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'color', 'white'),
														_1: {
															ctor: '::',
															_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'display', 'flex'),
															_1: {
																ctor: '::',
																_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'align-items', 'center'),
																_1: {
																	ctor: '::',
																	_0: A2(_elm_lang$virtual_dom$Main_ops['=>'], 'justify-content', 'center'),
																	_1: {ctor: '[]'}
																}
															}
														}
		...
		{
			ctor: '::',
			_0: _elm_lang$virtual_dom$AltHtml$text('Drag Me!'),
			_1: {ctor: '[]'}
		});
};
var _elm_lang$virtual_dom$Main$main = _elm_lang$virtual_dom$AltHtml$program(
	{init: _elm_lang$virtual_dom$Main$init, view: _elm_lang$virtual_dom$Main$view, update: _elm_lang$virtual_dom$Main$update, subscriptions: _elm_lang$virtual_dom$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _elm_lang$virtual_dom$Main$main !== 'undefined') {
    _elm_lang$virtual_dom$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"DragEnd":["Mouse.Position"],"DragAt":["Mouse.Position"],"DragStart":["Mouse.Position"]}}},"aliases":{"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
