...
var _elm_lang$virtual_dom$VirtualDom_History$emptyAddress = A3(_elm_lang$virtual_dom$VirtualDom_History$Address, 0, 0, 0);
...
var _elm_lang$virtual_dom$VirtualDom_History$viewCollapsedMessage = F5(
...
var _elm_lang$virtual_dom$VirtualDom_History$groupFolder = function (group) {
	var msg = F2(
		function (groupIndex, snapshotIndex) {
			return (group.collapsed ? _elm_lang$virtual_dom$VirtualDom_History$OpenGroup : _elm_lang$virtual_dom$VirtualDom_History$CloseGroup)(
...
var _elm_lang$virtual_dom$VirtualDom_History$viewGroup = F4(
	function (currentAddress, index, groupIndex, group) {
		...
		var children = group.collapsed ? {
			ctor: '::',
			_0: A5(
				_elm_lang$virtual_dom$VirtualDom_History$viewCollapsedMessage,
				currentAddress,
				groupIndex,
